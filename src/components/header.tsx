...
const Header: React.FC = () => {
  ...
  return (
    <div className="w-full h-14 px-3 bg-white flex justify-between items-center fixed border-bottom z-10">
      ...
      {/* <div
        className={`fixed top-0 right-0 h-full bg-gray-800 text-white transition-transform  w-3/4 shadow-lg z-20 
      ...
      >
        ...
        <div className="ps-4 ms-2 pt-3 ">
          ...
          >
            <FaHistory className="font-extrabold mt-1.5 me-2" />{" "}
          ...
          {isAdmin && (
            <>
              ...
              >
                <FaDatabase className="font-extrabold mt-1.5 me-2" />{" "}
