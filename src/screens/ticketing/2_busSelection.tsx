...
import { getBusColors, getBusInitials, getBusRoutes } from "../../constants/getLocalStorage";
...
const BusSelection: React.FC = () => {
  ...
  const handleBusInitialsSelection = (selected: { label: string; value: string }) =>{
  ...
  const handleBusRouteSelection = (selected: { label: string; value: string }) =>{
