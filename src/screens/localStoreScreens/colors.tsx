...
import { getBusColors } from "../../utils/getLocalStorage";
import useClickOutside from "../../utils/useClickOutside";

import { setBusColors} from "../../utils/setLocalStorage";
      ...
      >
        <div className="w-full creamBackground rounded-md border-2 shadow-md z-20 p-2">
            <div className="flex justify-between">
                <h5>Add Color<span className="text-xs"> (Click outside of modal to close)</span></h5>
...
{editModalOpen && (<div 
      ...
      >
        <div className="w-full creamBackground rounded-md border-2 shadow-md z-20 p-2">
            <div className="flex justify-between">
                <h5>Edit Color<span className="text-xs"> (Click outside of modal to close)</span></h5>
